...
public class AugGrammarParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, T__33=34, T__34=35, NUM=36, IDENT=37, STRING=38, WS=39;
	public static final int
		...
		RULE_num_expr = 13, RULE_t_num_expr = 14, RULE_f_num_expr = 15, RULE_negate = 16, 
		RULE_sub_num_expr = 17, RULE_read_int = 18, RULE_length = 19, RULE_position = 20, 
		RULE_str_expr = 21, RULE_read_str = 22, RULE_concatenate = 23, RULE_substring = 24, 
		RULE_bool_expr = 25, RULE_t_bool_expr = 26, RULE_f_bool_expr = 27, RULE_true = 28, 
		RULE_false = 29, RULE_sub_bool_expr = 30, RULE_not_expr = 31, RULE_num_rel_expr = 32, 
		RULE_num_rel = 33, RULE_num_eq_rel = 34, RULE_num_lt_rel = 35, RULE_num_le_rel = 36, 
		RULE_num_gt_rel = 37, RULE_num_ge_rel = 38, RULE_num_neq_rel = 39, RULE_str_rel_expr = 40, 
		RULE_str_rel = 41, RULE_str_eq_rel = 42, RULE_str_neq_rel = 43, RULE_ident = 44, 
		RULE_num = 45, RULE_string = 46;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"if_then_stat", "if_then_else_stat", "instr_block", "num_expr", "t_num_expr", 
			"f_num_expr", "negate", "sub_num_expr", "read_int", "length", "position", 
			"str_expr", "read_str", "concatenate", "substring", "bool_expr", "t_bool_expr", 
			"f_bool_expr", "true", "false", "sub_bool_expr", "not_expr", "num_rel_expr", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'begin'", "'end'", "'+'", "'-'", "'*'", "'/'", "'%'", "'readint'", "'length'", 
			"'position'", "','", "'readstr'", "'concatenate'", "'substring'", "'or'", 
			"'and'", "'true'", "'false'", "'not'", "'='", "'<'", "'<='", "'>'", "'>='", 
			"'<>'", "'=='", "'!='"
		};
	}
	...
	private T_num_exprContext t_num_expr(int _p) throws RecognitionException {
		...
		int _startState = 28;
		enterRecursionRule(_localctx, 28, RULE_t_num_expr, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final F_num_exprContext f_num_expr() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_f_num_expr);
		try {
			setState(206);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final NegateContext negate() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_negate);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(208);
	...
	public final Sub_num_exprContext sub_num_expr() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_sub_num_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(211);
	...
	public final Str_exprContext str_expr() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_str_expr);
		try {
			setState(234);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Read_strContext read_str() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_read_str);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(236);
	...
	public final ConcatenateContext concatenate() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_concatenate);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(238);
	...
	private Bool_exprContext bool_expr(int _p) throws RecognitionException {
		...
		int _startState = 50;
		enterRecursionRule(_localctx, 50, RULE_bool_expr, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	private T_bool_exprContext t_bool_expr(int _p) throws RecognitionException {
		...
		int _startState = 52;
		enterRecursionRule(_localctx, 52, RULE_t_bool_expr, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final F_bool_exprContext f_bool_expr() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_f_bool_expr);
		try {
			setState(282);
			_errHandler.sync(this);
	...
	public final TrueContext true_() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_true);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(284);
	...
	public final FalseContext false_() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_false);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(286);
	...
	public final Sub_bool_exprContext sub_bool_expr() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_sub_bool_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(288);
	...
	public final Not_exprContext not_expr() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_not_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(292);
	...
	public final Num_rel_exprContext num_rel_expr() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_num_rel_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(295);
	...
	public final Num_relContext num_rel() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_num_rel);
		try {
			setState(305);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Num_eq_relContext num_eq_rel() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_num_eq_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(307);
	...
	public final Num_lt_relContext num_lt_rel() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_num_lt_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(309);
	...
	public final Num_le_relContext num_le_rel() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_num_le_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(311);
	...
	public final Num_gt_relContext num_gt_rel() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_num_gt_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(313);
	...
	public final Num_ge_relContext num_ge_rel() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_num_ge_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(315);
	...
	public final Num_neq_relContext num_neq_rel() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_num_neq_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(317);
	...
	public final Str_rel_exprContext str_rel_expr() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_str_rel_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(319);
	...
	public final Str_relContext str_rel() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_str_rel);
		try {
			setState(325);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Str_eq_relContext str_eq_rel() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_str_eq_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(327);
	...
	public final Str_neq_relContext str_neq_rel() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_str_neq_rel);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(329);
	...
	public final NumContext num() throws RecognitionException {
		...
		enterRule(_localctx, 90, RULE_num);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(333);
